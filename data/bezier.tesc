...
void main() {
    ...
    if (gl_InvocationID == 0) {
        int level = calculateTesselation((gl_in[5].gl_Position.xzy + gl_in[6].gl_Position.xzy + gl_in[9].gl_Position.xzy + gl_in[10].gl_Position.xzy) / 4);
        gl_TessLevelInner[0] = level;
        gl_TessLevelInner[1] = level;
        gl_TessLevelOuter[0] = calculateTesselation((gl_in[0].gl_Position.xzy + gl_in[1].gl_Position.xzy + gl_in[2].gl_Position.xzy + gl_in[3].gl_Position.xzy) / 4);
        gl_TessLevelOuter[1] = calculateTesselation((gl_in[0].gl_Position.xzy + gl_in[4].gl_Position.xzy + gl_in[8].gl_Position.xzy + gl_in[12].gl_Position.xzy) / 4);
        gl_TessLevelOuter[2] = calculateTesselation((gl_in[12].gl_Position.xzy + gl_in[13].gl_Position.xzy + gl_in[14].gl_Position.xzy + gl_in[15].gl_Position.xzy) / 4);
        gl_TessLevelOuter[3] = calculateTesselation((gl_in[3].gl_Position.xzy + gl_in[7].gl_Position.xzy + gl_in[11].gl_Position.xzy + gl_in[15].gl_Position.xzy) / 4);
    }
